        ...
        <div className="flex flex-col md:flex-row max-w-5xl mx-auto gap-8">
          <div className="bg-white/10 p-8 rounded-xl mix-blend-luminosity">
            ...
            <p className="text-sm leading-7 my-3 font-light opacity-50">
              I am Web developer able to build a Web presence from the ground up - from concept, navigation, layout and
              programming. Skilled at writing well-designed, testable and efficient code using current best practices in
              Web development. Fast learner, hard worker and team player who is proficient in an array of scripting
              languages and multimedia Web tools. I have excellent design & coding skills, as well as an ability to
              convert requirements into exciting online applications.
            </p>
            <Link href="https://github.com/Klyabgame">
              <button className="bg-purple-500 py-2.5 px-8 rounded-full hover:bg-white hover:text-black">Github</button>
            </Link>
          </div>
          <div className="bg-white/10 p-8 rounded-xl mix-blend-luminosity">
          ...
          <div className="bg-white/10 p-8 rounded-xl mix-blend-luminosity">
            ...
            <p className="text-sm leading-7 my-3 font-light opacity-50">
              ...
              corporis iste? Omnis, neque. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt labore
              sapiente sit aliquam quia reprehenderit animi quidem voluptas tempora.
            </p>
            <Link href="https://github.com/debiig92">
              <button className="bg-purple-500 py-2.5 px-8 rounded-full hover:bg-white hover:text-black">Github</button>
            </Link>
          </div>
        </div>
